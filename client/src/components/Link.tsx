...
const variantClasses: Record<LinkVariant, Record<ColorScheme, string>> = {
  default: {
    primary: 'transition-colors duration-200 text-indigo-400 hover:text-indigo-300',
    neutral: 'transition-colors duration-200 text-gray-400 hover:text-gray-300',
  },
  underlined: {
    primary: 'transition-colors duration-200 text-indigo-400 underline hover:text-indigo-300',
    neutral: 'transition-colors duration-200 text-gray-400 underline hover:text-gray-300',
  },
};
